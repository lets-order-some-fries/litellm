...
class TestPromotedTraceControlFields:
    ...
    def test_promotes_unlisted_trace_prefixed_field(self):
        promoted = _promoted_trace_control_fields(
            requester_metadata={"trace_tags": ["a"], "trace_public": True},
            litellm_metadata={},
        )

        assert dict(promoted) == {"trace_tags": ["a"], "trace_public": True}
