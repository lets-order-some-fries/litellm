...
LITELLM_TRACE_CONTROL_METADATA_PREFIX: Final = "trace_"
...
def _promoted_trace_control_fields(
    ...
    return tuple(
        ...
        if key not in litellm_metadata
        and (key in LITELLM_TRACE_CONTROL_METADATA_FIELDS or key.startswith(LITELLM_TRACE_CONTROL_METADATA_PREFIX))
    )
